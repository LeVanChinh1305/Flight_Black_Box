...
#define MQTT_PUBLISH_PERIOD_MS 5000 // Gửi mỗi 5s
...
// Hàm callback khi nhận được tin nhắn MQTT (override hàm weak trong my_mqtt.cpp)
...
int main() {
  ...
  BaseType_t ok_MQTT = xTaskCreate(
    TaskMQTT,
    "MQTT",
